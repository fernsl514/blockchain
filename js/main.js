document.addEventListener("DOMContentLoaded", function() {
    ...
    welcomeButton.addEventListener('click', function() {
      ...
      // Animate the welcome area upward and fade it out
      content.classList.add('move-up');
      // After 1 second, display the terminal box and update its content with API data
      setTimeout(() => {
    ...
    async function updateMemeCoins() {
      ...
      // Use the typewriter effect to display the results in the terminal box
